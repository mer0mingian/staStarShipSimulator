...
-   **NIH (Not Invented Here) Syndrome:** Don't build custom solutions when established, high-quality libraries exist (e.g., auth, retry logic).
...
-   **Code Quality:** Favor early returns, break down complex functions/files.
-   **Custom Code Justification:** Only write custom code for logic unique to the business domain or security-sensitive paths.
