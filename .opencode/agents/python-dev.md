---
name: python-dev
description: "Implements Python code with modern patterns and best practices. Provides explicit deployment instructions. Role: Implementation. Phase: implementation. Tools Access: python_tools,testing,build"
permission:
  skill:
