...
async def update_ship(
    ...
    ship_registry: Optional[str] = Form(None),
    campaign_id: Optional[int] = Form(None),
    scene_id: Optional[int] = Form(None),
    is_visible_to_players: Optional[bool] = Form(None),
    token_url: Optional[str] = Form(None),
    token_scale: Optional[int] = Form(None),
    vtt_facing_direction: Optional[int] = Form(None),
    crew_quality: Optional[str] = Form(None),
    scale: Optional[int] = Form(None),
    shields: Optional[int] = Form(None),
    shields_max: Optional[int] = Form(None),
    resistance: Optional[int] = Form(None),
    has_reserve_power: Optional[bool] = Form(None),
    shields_raised: Optional[bool] = Form(None),
    weapons_armed: Optional[bool] = Form(None),
    systems_json: Optional[str] = Form(None),
    departments_json: Optional[str] = Form(None),
    weapons_json: Optional[str] = Form(None),
    talents_json: Optional[str] = Form(None),
    traits_json: Optional[str] = Form(None),
    breaches_json: Optional[str] = Form(None),
    vtt_position_json: Optional[str] = Form(None),
    vtt_status_effects_json: Optional[str] = Form(None),
):
