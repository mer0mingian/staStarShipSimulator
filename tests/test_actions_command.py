...
class TestRally:
    ...
    @pytest.mark.asyncio
    async def test_rally_success(self, client, sample_encounter, execute_action, test_session):
    ...
    @pytest.mark.asyncio
    async def test_rally_failure(self, client, sample_encounter, execute_action, test_session):
    ...
    @pytest.mark.asyncio
    async def test_rally_is_major(self, client, sample_encounter, execute_action, get_encounter_status, test_session):
    ...
    @pytest.mark.asyncio
    async def test_rally_has_difficulty_0(self, client, sample_encounter, execute_action, test_session):
    ...
    @pytest.mark.asyncio
    async def test_rally_generates_momentum(self, client, sample_encounter, execute_action, get_encounter_status, test_session):
    ...
    @pytest.mark.asyncio
    async def test_rally_uses_presence_and_command(self, client, sample_encounter, execute_action, test_session):
