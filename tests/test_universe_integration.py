...
class TestUniverseLibraryIntegration:
    ...
    @pytest.mark.asyncio
    async def test_list_library_characters_empty(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_list_library_characters(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_list_library_characters_invalid_category(self, client):
    ...
    @pytest.mark.asyncio
    async def test_list_library_ships_empty(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_list_library_ships(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_list_character_templates(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_list_ship_templates(self, client, test_session):
...
class TestImportToCampaign:
    ...
    @pytest.mark.asyncio
    async def test_import_character_to_campaign(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_import_character_missing_campaign_id(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_import_character_campaign_not_found(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_import_character_item_not_found(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_import_character_already_in_campaign(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_import_ship_to_campaign(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_import_ship_missing_campaign_id(self, client, test_session):
...
class TestAvailableItemsForCampaign:
    ...
    @pytest.mark.asyncio
    async def test_available_characters_for_campaign(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_available_characters_campaign_not_found(self, client):
    ...
    @pytest.mark.asyncio
    async def test_available_ships_for_campaign(self, client, test_session):
    ...
    @pytest.mark.asyncio
    async def test_available_ships_campaign_not_found(self, client):
