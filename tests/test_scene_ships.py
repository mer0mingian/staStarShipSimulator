...
class TestSceneShipsAPI:
    ...
    @pytest.fixture
    async def setup_scene_with_ship(self, test_session, sample_campaign):
    ...
    @pytest.mark.asyncio
    async def test_get_ships_empty(self, client, setup_scene_with_ship):
    ...
    @pytest.mark.asyncio
    async def test_add_ship(self, client, setup_scene_with_ship):
    ...
    @pytest.mark.asyncio
    async def test_add_ship_requires_ship_id(self, client, setup_scene_with_ship):
    ...
    async def test_add_ship_not_found(self, client, setup_scene_with_ship):
        ...
        assert "Ship not found" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_add_ship_not_in_campaign(
        ...
        assert response.status_code == 400
        assert "Ship not in campaign" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_add_ship_duplicate(self, client, setup_scene_with_ship):
    ...
    @pytest.mark.asyncio
    async def test_update_ship_not_found(self, client, setup_scene_with_ship):
        ...
        assert response.status_code == 404
        assert "Ship not found in scene" in response.json()["detail"]

    @pytest.mark.asyncio
    async def test_delete_ship(self, client, setup_scene_with_ship):
    ...
    @pytest.mark.asyncio
    async def test_authentication_required(self, client, setup_scene_with_ship):
    ...
    @pytest.mark.asyncio
    async def test_scene_not_found(self, client, setup_scene_with_ship):
...
class TestAvailableShipsHelper:
    ...
    @pytest.fixture
    async def setup_campaign_ships(self, test_session, sample_campaign):
    ...
    @pytest.mark.asyncio
    async def test_available_ships_requires_auth(self, client, setup_campaign_ships):
    ...
    @pytest.mark.asyncio
    async def test_available_ships_returns_list(self, client, setup_campaign_ships):
