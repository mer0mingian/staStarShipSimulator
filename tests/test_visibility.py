...
class TestAPIVisibility:
    ...
    @pytest.mark.asyncio
    async def test_status_api_filters_hidden_enemies_dust_cloud(self, client, sample_encounter, test_session):
    ...
    @pytest.mark.asyncio
    async def test_status_api_filters_hidden_enemies_dense_nebula(self, client, sample_encounter, test_session):
    ...
    @pytest.mark.asyncio
    async def test_status_api_shows_enemy_in_open_terrain(self, client, sample_encounter, test_session):
    ...
    @pytest.mark.asyncio
    async def test_status_api_shows_enemy_in_same_hex(self, client, sample_encounter, test_session):
    ...
    @pytest.mark.asyncio
    async def test_status_api_shows_all_to_gm(self, client, sample_encounter, test_session):
...
class TestMapAPIVisibility:
    ...
    @pytest.mark.asyncio
    async def test_map_api_filters_hidden_enemies(self, client, sample_encounter, test_session):
    ...
    @pytest.mark.asyncio
    async def test_map_api_shows_enemy_in_open_terrain(self, client, sample_encounter, test_session):
    ...
    @pytest.mark.asyncio
    async def test_map_api_shows_all_to_gm(self, client, sample_encounter, test_session):
