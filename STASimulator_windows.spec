...
"""PyInstaller spec file for STA Starship Simulator Windows app."""
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=True,  # Show console window so users can see the server URL
    disable_windowed_traceback=False,
    argv_emulation=False,
    target_arch=None,
    codesign_identity=None,
    entitlements_file=None,
    icon='star_mac_logo.png',  # PyInstaller will convert PNG to ICO on Windows
    version_file=None,
)
